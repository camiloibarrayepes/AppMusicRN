          ...
          >
            ...
            >
              <View style={{ flex: 4, flexDirection: 'row', alignItems: 'center' }}>
                ...
                <Animated.Text style={{ opacity: animatedSongTitleOpacity, fontSize: 18, paddingLeft: 10 }}>Green Day</Animated.Text>
              </View>
            ...
            <Animated.View style={{ height: animatedHeaderHeight, opacity: animatedSongDetailsOpacity }}>
              ...
              <View style={{ flex: 1, alignItems: 'center', justifyContent: 'flex-end' }}>
                <Text style={{ fontWeight: 'bold', fontSize: 22 }}>Holiday</Text>
                <Text style={{ fontSize: 18, color: 'red' }}>Green Day - American Idiot</Text>
              </View>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 20, paddingBottom: 20 }}>
                <Ionicons name="md-add" size={32} style={{ marginBottom:10, color: 'red' }} />
                <Ionicons name="md-more" size={32} style={{ color: 'red' }} />
              </View>
            </Animated.View>
